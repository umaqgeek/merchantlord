...
public class Login extends javax.swing.JFrame {
    ...
    private void loginProcess() {
        ...
        boolean isValid = rmic.isLoginMerchant(user, pass);

        if (isValid) {

            SessionsDP.setMe_username(user);
...
//        if (txt_user.getText().equals("aaa")) {
//            // generate pdf receipt
//            PaymentReceipt pr1 = new PaymentReceipt("Payment_Receipt");
//            pr1.generate(1, 24875);
//        }
